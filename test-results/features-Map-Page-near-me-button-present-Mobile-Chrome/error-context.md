...
- Name: features.spec.ts >> Map Page >> near me button present
...
Locator:  locator('button:has-text("Near me")')
Expected: visible
Received: hidden
Timeout:  3000ms
